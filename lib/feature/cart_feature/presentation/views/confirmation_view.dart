      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("your order code # 557775",style: CustomTextStyle.TitilliumWebBold16.copyWith(fontSize: 26,color: AppColor.red),),
            Text("Thank you for choosing ouor products",style: CustomTextStyle.regular,),
